				...
				{isResizable && (
					<>
						...
						<Resizer
							...
							className='absolute end-[-20px] top-1/2 -translate-y-1/2'
						>
						...
						<Resizer
							...
							className='absolute start-1/2 bottom-[-20px] -translate-x-1/2 cursor-ns-resize rtl:translate-x-1/2'
						>
...
const Resizer = ({
	...
	return (
		<div
			className={cn(
				"z-[1001] flex h-4 w-4 touch-none items-center justify-center rounded-sm border bg-border hover:bg-muted",

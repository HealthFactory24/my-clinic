...
export const LayerContextMenuPortal: React.FC = () => {
	...
	const menuContent = (
		<div
			className='fade-in-0 zoom-in-95 z-[10000] min-w-[14rem] animate-in overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md'
...
const MenuShortcut: React.FC<{ children: React.ReactNode }> = ({
	...
	return (
		<span
			className='ms-auto text-xs tracking-widest opacity-60'

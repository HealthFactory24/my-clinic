	...
	return (
		...
		>
			...
			<div className='flex size-full flex-col overflow-hidden md:hidden'>
				...
				<div className='absolute start-4 end-4 bottom-4 z-50'>
...
export function defaultConfigTabsContent(
	...
	const tailwindThemePanelContent =
		getTailwindThemePanelContent(tailwindThemePanel);
...
export function LoadingSkeleton() {
	return (
		<div
			className='flex flex-1 flex-col gap-1 bg-secondary/90'
			data-testid='loading-skeleton'
		>
			<div className='h-16 w-full animate-pulse rounded-md bg-background' />
			<div className='flex flex-1 gap-1'>
				<div className='w-1/4 animate-pulse rounded-md bg-background' />
				<div className='w-1/2 animate-pulse rounded-md bg-muted-background/90' />
				<div className='w-1/4 animate-pulse rounded-md bg-background' />
			</div>
		</div>
	);

...
export const DragOverlayContent: React.FC<DragOverlayContentProps> = ({
	...
	return (
		<div className='pointer-events-none mt-10 min-w-fit text-nowrap rounded-lg border-2 border-primary/50 bg-white px-3 py-2 font-medium text-sm opacity-90 shadow-lg dark:bg-gray-800'>
			{displayName}
		</div>
	);
};

...
import {
	...
	type findAllParentLayersRecursive,
	findLayerRecursive,
	hasLayerChildren,
	migrateV1ToV2,
	migrateV2ToV3,
...
export interface LayerStore {
	...
	addPageLayer: (
		pageId: string,
		pageType?: string,
		rootLayerType?: string,
		rootLayerProps?: Record<string, unknown>
	) => void;
		...
		set(
			produce((state: LayerStore) => {
				...
				const newPage: ComponentLayer = {
					...
					props: (rootLayerProps ??
						(rootLayerType !== undefined && rootLayerType !== "div"
							? {}
							: DEFAULT_PAGE_PROPS)) as ComponentLayer["props"],
					children: []
				};
				return {
...
export { type countLayers, type findAllParentLayersRecursive, useLayerStore };
